      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="tel:+33665674735" className="text-white/70 hover:text-white transition-smooth">
          ...
          <div className="hidden md:block">
            <Button asChild variant="default" className="gradient-accent hover:opacity-90 transition-smooth text-black font-semibold">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-6 animate-fade-in">
            <nav className="flex flex-col gap-4">
              ...
              <Button asChild variant="default" className="gradient-accent mt-4 w-full text-black font-semibold">
